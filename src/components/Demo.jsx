...
const Demo = () => {
  ...
  //Browse History in local storage
  useEffect(() => {
  ...
  //Save to local storage, display summarized article and enter an article
    ...
    <section className="mt-16 w-full max-w-xl">
        ...
        <div className="flex flex-col gap-1 max-h-60 overflow-y-auto">
          {allArticles.map((item, index) => (
            ...
            >
              ...
              <p className="flex-1 font-satoshi text-blue-700 font-medium test-sm truncate">
                {item.url}
              </p>
            </div>
          ))}
      ...
      <div className="my-10 max-w-full flex justify-center">
        {isFetching ? (
          ...
          <p className="font-inter font-bolt text-black text-center">
